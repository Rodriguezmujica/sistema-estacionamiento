...
echo "🔍 VERIFICAR TRANSACTION ID REAL\n";
echo "================================\n\n";
...
try {
    ...
    if ($data) {
        ...
        if (isset($data['error']) && $data['error'] === true) {
            ...
            if (isset($data['code']) && $data['code'] === 'MR-160') {
                echo "\n   💡 Explicación MR-160:\n";
                echo "   - El Transaction ID no existe en TUU\n";
                echo "   - Puede ser que haya expirado\n";
                echo "   - O que no pertenezca a tu cuenta\n";
            }
        } else {
    ...
    echo "========================\n";
    echo "a) El Transaction ID de la documentación es solo un ejemplo\n";
    echo "b) Tu API Key solo ve solicitudes de tu cuenta\n";
    echo "c) Las solicitudes antiguas expiran automáticamente\n";
    echo "d) Necesitas usar un Transaction ID de tu propia cuenta\n";
